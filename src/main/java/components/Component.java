...
public abstract class Component {
    ...
    public void beginCollision(GameObject collidingObject, Contact contact, Vector2f aNormal){

    }

    public void endCollision(GameObject collidingObject, Contact contact, Vector2f aNormal){
    ...
    public void destroy(){
        //play some sound or switch a new scene
    }
