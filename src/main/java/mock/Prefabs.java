...
public class Prefabs {
    ...
    public static GameObject generateQuestionBlock(){
        ...
        float defaultFrameTime = 0.46f;
        flicker.addFrame(item.getSprite(0), defaultFrameTime);
        flicker.addFrame(item.getSprite(1), defaultFrameTime);
        flicker.addFrame(item.getSprite(2), defaultFrameTime);
        flicker.setLoop(true);

        AnimationState inactive = new AnimationState();
        inactive.title = "Inactive";
        inactive.addFrame(item.getSprite(3), 0.2f);
    ...
    public static GameObject generateBlockCoin(){
        Spritesheet item = AssetPool.getSpritesheet("assets/images/items.png");
        GameObject coin = generateSpriteObject(item.getSprite(7),0.25f,0.25f);

        AnimationState coinFlip = new AnimationState();
        coinFlip.title = "Question";
        float defaultFrameTime = 0.46f;
        coinFlip.addFrame(item.getSprite(7), defaultFrameTime);
        coinFlip.addFrame(item.getSprite(8), defaultFrameTime);
        coinFlip.addFrame(item.getSprite(9), defaultFrameTime);
    ...
    public static GameObject generateFlower(){
        Spritesheet item = AssetPool.getSpritesheet("assets/images/items.png");
        GameObject flower = generateSpriteObject(item.getSprite(20),0.25f,0.25f);
    ...
    public static GameObject generateSlime(){
        ...
        slime.addComponent(stateMachine);

        Rigidbody2D rb = new Rigidbody2D();
        rb.setBodyType(BodyType.Dynamic);
        rb.setMass(0.1f);
        rb.setFixedRotation(true);
        slime.addComponent(rb);

        CircleCollider circle = new CircleCollider();
        circle.setRadius(0.12f);
        slime.addComponent(circle);

        slime.addComponent(new SlimeAI());
    ...
    public static GameObject generateFlagtop(){
        Spritesheet item = AssetPool.getSpritesheet("assets/images/items.png");
        GameObject flagtop = generateSpriteObject(item.getSprite(6),0.25f,0.25f);
    ...
    public static GameObject generateFlagPole(){
        Spritesheet item = AssetPool.getSpritesheet("assets/images/items.png");
        GameObject flagpole = generateSpriteObject(item.getSprite(33),0.25f,0.25f);
    ...
    public static GameObject generateFireball(Vector2f position){
        Spritesheet item = AssetPool.getSpritesheet("assets/images/items.png");
        GameObject fireball = generateSpriteObject(item.getSprite(32),0.18f,0.18f);
